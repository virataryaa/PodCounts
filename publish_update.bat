...
echo ============================================
echo  Cocoa Pod Counts data publish
echo ============================================
echo.

echo Step 1/3: Validating Database.xlsx ...
python validate_xlsx.py
if errorlevel 1 (
    echo.
    echo ============================================
    echo  VALIDATION FAILED - nothing was pushed.
    echo  Fix the issues above in "Database\Database.xlsx", then run this again.
    echo ============================================
    pause
    exit /b 1
)
...
git diff --quiet -- "Database\Database.xlsx"
if not errorlevel 1 (
    echo No changes detected in "Database\Database.xlsx" - nothing to push.
    pause
    exit /b 0
)
...
git add "Database\Database.xlsx"
